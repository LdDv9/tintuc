...
(function() {
            ...
            proto: {
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
                                    ...
                                    for (; g = d.getItem(f++);)
                                        if (!D(g)) { d = !0; break a }
                                d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), w(a.startContainer) && a.startContainer.appendBogus();
    ...
    */
            ...
            init: function(a) {
                if (CKEDITOR.env.webkit) {
                    ...
                    a.on("contentDom", function(a) {
                        ...
                        var d = a.document,
                            e = a.editable();
                        e.attachListener(d, "keydown", function(a) { var c = a.data.$;
                            65 == a.data.getKey() && (CKEDITOR.env.mac && c.metaKey || !CKEDITOR.env.mac && c.ctrlKey) && CKEDITOR.tools.setTimeout(function() { b.addFillers(e) || b.removeFillers(e) }, 0) }, null, null, -1);
                        a.on("selectionCheck",
                            function(a) { b.removeFillers(a.editor.editable()) });
    ...
    (function() {
            ...
            if ("wysiwyg" == this.editor.mode) {
                ...
                if (b) {
                    ...
                    if (a && a.initOnlyNew) c = this.initOnAll();
                            ...
                            c = [];
                        d = 0; for (e = l.count(); d < e; d++) { f = l.getItem(d); if (h = !this.getByElement(f, !0)) { a: { h = Q; for (var k = f; k = k.getParent();)
                                        if (h(k)) { h = !0; break a }
                                    h = !1 } h = !h } h && b.contains(f) && (f.addClass("cke_widget_new"), c.push(this.initOn(f.getFirst(g.isDomWidgetElement)))) } } a && a.focusInited && 1 == c.length && c[0].focus()
                }
            }
        }
        ...
        function v(a, b) { return { tabindex: -1, contenteditable: "false", "data-cke-widget-wrapper": 1, "data-cke-filter": "off", "class": "cke_widget_wrapper cke_widget_new cke_widget_" + (a ? "inline" : "block") + (b ? " cke_widget_" + b : "") } }

        function w(a, b, c) { if (a.type == CKEDITOR.NODE_ELEMENT) { var d = CKEDITOR.dtd[a.name]; if (d && !d[c.name]) { var d = a.split(b),
                        e = a.parent;
                    b = d.getIndex();
                    a.children.length || (--b, a.remove());
                    d.children.length || d.remove(); return w(e, b, c) } } a.add(c, b) }

        function x(a, b) { return "boolean" == typeof a.inline ? a.inline : !!CKEDITOR.dtd.$inline[b] }

        function Q(a) { return a.hasAttribute("data-cke-temp") }

        function n(a, b, c, d) {
            var e = a.editor;
            e.fire("lockSnapshot");
            c ? (d = c.data("cke-widget-editable"), d = b.editables[d], a.widgetHoldingFocusedEditable =
        ...
        function S(a) { a.contextMenu && a.contextMenu.addListener(function(b) { if (b = a.widgets.getByElement(b, !0)) return b.fire("contextMenu", {}) }) }

        function T(a,
            b) { return CKEDITOR.tools.trim(b) }

        function L(a) {
            var b = a.editor,
                c = CKEDITOR.plugins.lineutils;
            b.on("dragstart", function(d) { var c = d.data.target;
            ...
            b.on("drop", function(c) {
                var e = c.data.dataTransfer,
                    ...
                    e = b.createRange();
                "" !== f && h === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c.cancel() : "" !== f && h == CKEDITOR.DATA_TRANSFER_INTERNAL && (f = a.instances[f]) &&
                    (e.setStartBefore(f.wrapper), e.setEndAfter(f.wrapper), c.data.dragRange = e, delete CKEDITOR.plugins.clipboard.dragStartContainerChildCount, delete CKEDITOR.plugins.clipboard.dragEndContainerChildCount, c.data.dataTransfer.setData("text/html", b.editable().getHtmlFromRange(e).getHtml()), b.widgets.destroy(f, !0))
            });
            b.on("contentDom", function() {
                var d = b.editable();
                CKEDITOR.tools.extend(a, {
                    finder: new c.finder(b, {
                        lookups: {
                            "default": function(b) {
                                if (!b.is(CKEDITOR.dtd.$listItem) && b.is(CKEDITOR.dtd.$block) && !g.isDomNestedEditable(b) &&
                                    !a._.draggedWidget.wrapper.contains(b)) { var c = g.getNestedEditable(d, b); if (c) { b = a._.draggedWidget; if (a.getByElement(c) == b) return;
        ...
        function J(a) {
            ...
            b.on("contentDom", function() {
                var c = b.editable(),
                    ...
                    e, f;
                c.attachListener(d, "mousedown", function(c) { var d = c.data.getTarget();
        ...
        function K(a) {
            a.editor.on("key", function(b) {
                var c = a.focused,
                    ...
                    e;
                c ? e = c.fire("key", { keyCode: b.data.keyCode }) : d &&
        ...
        function M(a) {
            function b(b) { a.focused && y(a.focused, "cut" == b.name) }
            var c = a.editor;
            c.on("contentDom", function() {
                var a = c.editable();
                a.attachListener(a,
        ...
        function I(a) {
            ...
            b.on("selectionChange", function(c) { var d = (c = g.getNestedEditable(b.editable(), c.data.selection.getStartElement())) && a.getByElement(c),
        ...
        function G(a) {
            ...
            b.on("toDataFormat", function(b) {
                ...
                b.data.dataValue.forEach(function(b) {
                    var c = b.attributes,
                        d;
                    if ("data-cke-widget-id" in c) { if (c = a.instances[c["data-cke-widget-id"]]) d = b.getFirst(g.isParserWidgetElement), f.push({ wrapper: b, element: d, widget: c, editables: {} }), "1" != d.attributes["data-cke-widget-keep-attr"] && delete d.attributes["data-widget"] } else if ("data-cke-widget-editable" in
                        c) return f[f.length - 1].editables[c["data-cke-widget-editable"]] = b, !1
        ...
        function F(a) {
            var b = a.editor,
                c, d;
            b.on("toHtml", function(b) { var d = R(a),
                        h; for (b.data.dataValue.forEach(d.iterator, CKEDITOR.NODE_ELEMENT, !0); h = d.toBeWrapped.pop();) { var l = h[0],
                            k = l.parent;
        ...
        function z(a) {
            ...
            return {
                ...
                commit: function() { var f = a.focused !== e,
                        h, g;
                    a.editor.fire("lockSnapshot"); for (f && (h = a.focused) && t(a, h); h = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, h), 1), h.isInited() && (g = h.editor.checkDirty(), h.setSelected(!1), !g && h.editor.resetDirty());
                    f && e && (g = a.editor.checkDirty(), a.focused = e, a.fire("widgetFocused", { widget: e }), e.setFocused(!0), !g && a.editor.resetDirty()); for (; h = c.pop();) b.push(h), h.setSelected(!0);
        ...
        function y(a, b) {
            ...
            if (!d.getById("cke_copybin")) {
                ...
                f.setStyle("ltr" == c.config.contentsLangDirection ?
                    "left" : "right", "-5000px");
                var g = c.createRange();
                ...
                setTimeout(function() { b || a.focus();
                    ...
                    b && (a.repository.del(a), c.fire("saveSnapshot")) }, 100)
            }
        }

        function B(a) { return (a = (a = a.getDefinition().attributes) && a["class"]) ? a.split(/\s+/) : null }

        function D() { var a = CKEDITOR.document.getActive(),
                b = this.editor,
                c = b.editable();
        ...
        function X(a) {
            if (a.draggable) {
                ...
                if (!a.inline && (d.on("mousedown", Y, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function(a) { a.data.preventDefault(!0) });
        ...
        function aa(a) { if (a.mask) { var b = a.wrapper.findOne(".cke_widget_mask");
        ...
        function ba(a) { if (a.parts) { var b = {},
                    c, d; for (d in a.parts) c = a.wrapper.findOne(a.parts[d]), b[d] = c;
                a.parts = b } }
        ...
        function N(a, b) {
            ...
            a.on("key", function(b) { b = b.data.keyCode; if (13 == b) a.edit();
                else { if (b == CKEDITOR.CTRL + 67 || b == CKEDITOR.CTRL + 88) { y(a, b == CKEDITOR.CTRL + 88); return } if (b in da || CKEDITOR.CTRL & b || CKEDITOR.ALT & b) return } return !1 }, null, null, 999);
            a.on("doubleclick",
                function(b) { a.edit() && b.cancel() });
        ...
        function r(a) { a.element.data("cke-widget-data", encodeURIComponent(JSON.stringify(a.data))) } CKEDITOR.plugins.add("widget", {
            ...
            afterInit: function(a) { var b = a.widgets.registered,
        ...
        p.prototype = {
            ...
            checkSelection: function() { var a = this.editor.getSelection(),
                    b = a.getSelectedElement(),
                    c = z(this),
                    d; if (b && (d = this.getByElement(b, !0))) return c.focus(d).select(d).commit();
                a = a.getRanges()[0]; if (!a || a.collapsed) return c.commit();
                a = new CKEDITOR.dom.walker(a); for (a.evaluator = g.isDomWidgetWrapper; b = a.next();) c.select(this.getByElement(b));
                c.commit() },
            ...
            getByElement: function() {
                function a(a) { return a.is(b) && a.data("cke-widget-id") } var b = { div: 1, span: 1 }; return function(b, d) { if (!b) return null; var e = a(b); if (!d && !e) { var f = this.editor.editable();
                        do b = b.getParent(); while (b && !b.equals(f) && !(e = a(b))) } return this.instances[e] || null } }(),
            ...
            initOnAll: function(a) { a = (a || this.editor.editable()).find(".cke_widget_new"); for (var b = [], c, d = a.count(); d--;)(c = this.initOn(a.getItem(d).getFirst(g.isDomWidgetElement))) && b.push(c); return b },
            onWidget: function(a) {
                var b =
                    Array.prototype.slice.call(arguments);
                b.shift();
                for (var c in this.instances) { var d = this.instances[c];
                    d.name == a && d.on.apply(d, b) } this.on("instanceCreated", function(d) { d = d.data;
                    d.name == a && d.on.apply(d, b) })
            },
            parseElementClasses: function(a) { if (!a) return null;
                a = CKEDITOR.tools.trim(a).split(/\s+/); for (var b, c = {}, d = 0; b = a.pop();) - 1 == b.indexOf("cke_") && (c[b] = d = 1); return d ? c : null },
        ...
        g.prototype = {
            ...
            checkStyleActive: function(a) { a = B(a); var b; if (!a) return !1; for (; b = a.pop();)
            ...
            edit: function() {
                ...
                this.editor.openDialog(a.dialog, function(a) {
                    var d, e;
                    !1 !== b.fire("dialog", a) && (d = a.on("show", function() { a.setupContent(b) }), e = a.on("ok", function() { var d, e = b.on("data", function(a) { d = 1;
                            a.cancel() }, null, null, 0);
                        b.editor.fire("saveSnapshot");
                        a.commitContent(b);
                        e.removeListener();
                        d && (b.fire("data", b.data), b.editor.fire("saveSnapshot")) }), a.once("hide", function() {
                        d.removeListener();
                        e.removeListener()
                    }))
                });
            ...
            initEditable: function(a, b) {
                ...
                return c && c.is(CKEDITOR.dtd.$editable) ? (c = new q(this.editor, c, { filter: u.call(this.repository, this.name, a, b) }), this.editables[a] = c, c.setAttributes({ contenteditable: "true", "data-cke-widget-editable": a, "data-cke-enter-mode": c.enterMode }), c.filter &&
            ...
            _findOneNotNested: function(a) { a = this.wrapper.find(a); for (var b, c, d = 0; d < a.count(); d++)
                    if (b = a.getItem(d), c = b.getAscendant(g.isDomWidgetWrapper), this.wrapper.equals(c)) return b; return null },
            isInited: function() {
                return !(!this.wrapper ||
                    !this.inited)
            },
        ...
        g.isDomDragHandler = function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("data-cke-widget-drag-handler") };
        ...
        q.prototype = CKEDITOR.tools.extend(CKEDITOR.tools.prototypedCopy(CKEDITOR.dom.element.prototype), {
            setData: function(a) { this._.initialSetData || this.editor.widgets.destroyAll(!1, this);
        ...
        (function() {
            ...
            CKEDITOR.style.addCustomHandler({
                ...
                checkApplicable: function(a, b) { return b instanceof CKEDITOR.editor ? this.checkElement(a.lastElement) : !1 },
                checkElementMatch: b,
                ...
                toAllowedContentRules: function(a) {
                    ...
                    var b, c = {};
                    if (!a) return null;
                    if (a.styleableElements) { b = this.getClassesArray(); if (!b) return null;
    ...
    (function() {
        ...
        function m(a) { var d = a.match(l)[1];
            a = a.replace(l, "");
            a = atob(a); var b = [],
                c, f, e, g; for (c = 0; c < a.length; c += 512) { f = a.slice(c, c + 512);
                e = Array(f.length); for (g = 0; g < f.length; g++) e[g] = f.charCodeAt(g);
                f = new Uint8Array(e);
                b.push(f) } return new Blob(b, { type: d }) } CKEDITOR.plugins.add("filetools", {
            beforeInit: function(a) {
                ...
                a.on("fileUploadRequest", function(a) { var b = a.data.fileLoader,
                        c = new FormData;
                    a = a.data.requestData; for (var f in a) { var e = a[f]; "object" === typeof e && e.file ? c.append(f, e.file, e.name) : c.append(f, e) } c.append("ckCsrfToken", CKEDITOR.tools.getCsrfToken());
                    b.xhr.send(c) }, null, null, 999);
        ...
        h.prototype = { create: function(a, d) { var b = this.loaders.length,
                    c = new k(this.editor, a, d);
                c.id = b;
                this.loaders[b] = c;
                this.fire("instanceCreated", c); return c }, isFinished: function() { for (var a = 0; a < this.loaders.length; ++a)
        ...
        k.prototype = {
            ...
            load: function() {
                ...
                d.onabort = function() { a.changeStatus("abort") };
                d.onerror = function() { a.message = a.lang.filetools.loadError;
                    a.changeStatus("error") };
                d.onprogress = function(b) { a.loaded = b.loaded;
                    a.update() };
                d.onload = function() { a.loaded = a.total;
                    a.data = d.result;
                    a.changeStatus("loaded") };
                d.readAsDataURL(this.file)
            },
            upload: function(a, d) { var b = d || {};
            ...
            attachRequestListeners: function() {
                function a() { "error" != b.status && (b.message = b.lang.filetools.networkError, b.changeStatus("error")) }

                function d() { "abort" != b.status && b.changeStatus("abort") }
                var b = this,
                    c = this.xhr;
                b.abort = function() { c.abort();
                    d() };
                c.onerror = a;
                c.onabort = d;
                c.upload ? (c.upload.onprogress = function(a) { a.lengthComputable && (b.uploadTotal || (b.uploadTotal = a.total), b.uploaded = a.loaded, b.update()) }, c.upload.onerror = a, c.upload.onabort = d) : (b.uploadTotal = b.total, b.update());
                c.onload = function() {
                    b.update();
                    if ("abort" != b.status)
                        ...
                        else { for (var a = { fileLoader: b }, d = ["message", "fileName", "url"], g = b.editor.fire("fileUploadResponse", a), h = 0; h < d.length; h++) { var k = d[h]; "string" === typeof a[k] && (b[k] = a[k]) } b.responseData = a;
                            delete b.responseData.fileLoader;!1 === g ? b.changeStatus("error") : b.changeStatus("uploaded") }
                }
            },
        ...
        CKEDITOR.tools.extend(CKEDITOR.fileTools, {
            addUploadWidget: function(a, e, c) {
                ...
                if (c.fileToElement) a.on("paste", function(f) {
                    ...
                    if (!f.dataValue && k)
                        for (h = 0; h < k; h++)
                            if (d = n.getFile(h), !c.supportedTypes || g.isTypeSupported(d, c.supportedTypes)) { var l = c.fileToElement(d);
                                d = b.create(d);
                ...
                CKEDITOR.tools.extend(c, {
                    ...
                    init: function() {
                        var f = this,
                            ...
                            d, h;
                        k.on("update", function(b) { if (f.wrapper && f.wrapper.getParent()) { a.fire("lockSnapshot");
                                b = "on" + c(k.status); if ("function" !== typeof f[b] || !1 !== f[b](k)) h = "cke_upload_" + k.status, f.wrapper && h != d && (d && f.wrapper.removeClass(d), f.wrapper.addClass(h), d = h), "error" != k.status && "abort" != k.status || a.widgets.del(f);
                                a.fire("unlockSnapshot") } else a.editable().find('[data-cke-upload-id\x3d"' + e + '"]').count() || k.abort(), b.removeListener() });
                        k.update()
                    },
                    replaceWith: function(b,
                        e) { if ("" === b.trim()) a.widgets.del(this);
                        else { var c = this == a.widgets.focused,
                                g = a.editable(),
                                d = a.createRange(),
                                h, l;
            ...
            markElement: function(a, e, c) { a.setAttributes({ "data-cke-upload-id": c, "data-widget": e }) },
            bindNotifications: function(a, e) {
                function c() { g = a._.uploadWidgetNotificaionAggregator; if (!g || g.isFinished()) g = a._.uploadWidgetNotificaionAggregator = new CKEDITOR.plugins.notificationAggregator(a, a.lang.uploadwidget.uploadMany, a.lang.uploadwidget.uploadOne), g.once("finished", function() { var b = g.getTaskCount();
                        0 === b ? g.notification.hide() : g.notification.update({ message: 1 == b ? a.lang.uploadwidget.doneOne : a.lang.uploadwidget.doneMany.replace("%1", b), type: "success", important: 1 }) }) }
                var g, b = null;
                e.on("update",
                    function() {!b && e.uploadTotal && (c(), b = g.createTask({ weight: e.uploadTotal }));
                        b && "uploading" == e.status && b.update(e.uploaded) });
                e.on("uploaded", function() { b && b.done() });
                e.on("error", function() { b && b.cancel();
                    a.showNotification(e.message, "warning") });
                e.on("abort", function() { b && b.cancel();
                ...
                if (CKEDITOR.plugins.clipboard.isFileApiSupported) {
                    ...
                    h ? (f.addUploadWidget(d, "uploadimage", {
                        ...
                        fileToElement: function() { var a = new CKEDITOR.dom.element("img");
                            a.setAttribute("src", k); return a },
                        parts: { img: "img" },
                        onUploading: function(a) {
                            this.parts.img.setAttribute("src",
                                a.data)
                        },
                        onUploaded: function(a) { var b = this.parts.img.$;
